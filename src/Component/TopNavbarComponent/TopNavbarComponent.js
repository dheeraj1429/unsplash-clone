...
import SearchDivComponent from "../SearchDivComponent/SearchDivComponent";

import "./TopNavbarComponent.css";

function TopNavbarComponent({ User }) {
        ...
        <div className="NavLinkDiv">
          ...
          {User == null ? (
            ...
            <div className="UserProfileDiv">
              ...
              ></div>
              <PopUpcomponent
                SideBarContentPopUp={"UserDetails"}
                userName={User}
                ContentData={null}
                ClassData={ShowDivOne == true ? "hideMenu" : ""}
              />
            </div>
          )}
