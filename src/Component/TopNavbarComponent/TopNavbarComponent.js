...
function TopNavbarComponent() {
  ...
  const selector = useSelector((state) => state.user.navInnerContent);
      ...
      <div className="TopNavbarContent">
        <div className="NavLinkDiv">
          ...
          <div className="UserProfileDiv">
            ...
            ></div>
            <PopUpcomponent ContentData={null} ClassData={ShowDivOne == true ? "hideMenu" : ""} />
          </div>
          ...
          <div className="MenuDiv">
            ...
            <PopUpcomponent ContentData={selector} ClassData={ShowDiv == true ? "hideMenu" : ""} />
          </div>
        </div>
      </div>
    </div>
